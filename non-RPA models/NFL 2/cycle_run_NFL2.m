...
response_cell = {'Responses for NFL_2', 0,0,0,0,0,0,0};
...
parfor i = 1:length(parameter_set(:,1))
    ...
    F = @(y) NFL_2(0, y, parameter_set(i,:), out_type, 0);
    ...
    for k = 1:2*(time/T)
        ...
        [T_iter,Y_iter] = ode45(@(t, y) NFL_2(t, y, parameter_set(i,:), out_type, 1), [t_start, t_end], x0);
        To = [To; T_iter];
        Y = [Y; Y_iter];
    end
    % interpret results
