...
title(['RPA IFFL original', ', k1 = ', num2str(parameters1(1)), ', k2 = ', num2str(parameters2(1)), ', k3 = ', num2str(parameters3(1)), ', k4 = ', num2str(parameters4(1)), ', k5 = ', num2str(parameters5(1))], 'Fontsize', 10)
ax = gca;
ax.FontSize = 16;
